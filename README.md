...
SQL databases are known as relational databases, confusing way of asking this question.
I take it you mean non-relational databases, which can be document based, graph databases, simple key-value pairs, and other things. 

2. Why do tables need a Primary Key?

It wouldn't workout without. It's the anker, the core, the priority table we link everything to.
...
Make a third table with primary keys of both